...
function _classCallCheck(e, t) {
    ...
    try {
        if (top.window._qqmusic_player) n = e._qqmusic_player = top.window._qqmusic_player;
        else {
    ...
    var a = {
        ...
        extend: function () {
            var e = void 0,
                ...
                c = s.length,
                d = !1;
            for (a.isBoolean(u) && (d = u, u = s[l] || {}, l++), l === c ? (u = {}, l--) : a.isObject(u) || a.isFunction(u) || (u = {}); l < c; l++)
                if (null != (e = s[l]))
                    for (t in e) n = u[t], u !== (i = e[t]) && (d && i && ((r = Array.isArray(i)) || a.isObject(i)) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && a.isObject(n) ? n : {}, u[t] = a.extend(d, o, i)) : void 0 !== i && (u[t] = i));
            return u
        },
        ...
        client: {
            ...
            on: function (t, n) {
                if (a.ua.music) {
                    if (e.M && M.client && a.isFunction(M.client.on)) M.client.on(t, n);
                    else {
                        var i = "evt-" + t;
                        this.map[i] ? this.map[i].push(n) : (this.map[i] = [n], this.invoke("event", "on", {
                            event: t
                        }))
                    }
                }
            ...
            invoke: function (e, t, i, r, o) {
                ...
                var l = void 0;
                if (a.ua.ios) l = +new Date, location.href = u;
                else {
        ...
        getACSRFToken: function (e) {
            e = e || "skey";
            var t = a.cookie.get(e),
                n = 5381;
            if (t)
                for (var i = 0, r = t.length; i < r; ++i) n += (n << 5) + t.charCodeAt(i);
            return 2147483647 & n
        },
        jsonp: function (i) {
            if (i) {
                var r = "player_jsonp_" + n.getGUID(),
                    o = {
                        g_tk: a.user.g_tk,
                        uin: a.user.uin || 0,
                        format: "json",
                        callback: r,
                        data: JSON.stringify(a.extend({
                            comm: {
                                ct: 23,
                                cv: 0
                            }
        ...
        serializeSongData: function (e) {
            ...
            return a.isString(e) && a.reg.list.test(e) ? e = e.split(",") : a.isArray(e) || (e = [e]), e.forEach(function (e) {
                e && (e = a.reg.mid.test(e) ? {
                    mid: e
                } : e > 0 ? {
                    id: e
                } : a.reg.url.test(e) ? {
                    url: e
                } : a.isNormSong(e) || a.isObject(e) && e.url ? a.extend({}, e) : null) && (e.id && (e.id = parseInt(e.id)), null == e.type && (e.type = 0)), t.push(e)
            }), t
        },
        ...
        msginfo: {
            ...
            def: "鎶辨瓑锛屾殏鏃跺惉涓嶄簡杩欓姝屼簡",
            pay: "搴旂増鏉冩柟瑕佹眰涓嶈兘鍏嶈垂鎾斁锛屽彲浠樿垂鍚庣晠浜�",
            msginfo: null,
            get: function (e, t) {
                var n = this;
                e || (e = {});
                var i = (e.action || {}).msgid,
                    r = function () {
                        var r = n.msginfo && n.msginfo[i],
                            a = void 0;
        ...
        convert: {
            rule: [
                [null, "type", null, "type"],
                [null, "id", null, "songid"],
                [null, "mid", null, "songmid"],
                [null, "name", null, "songname"],
                ["action", "alert", null, "alertid"],
                ["action", "msgid", null, "msgid"],
                ["action", "switch", null, "switch"],
                [null, "singer", null, "singer"],
                ["album", "id", null, "albumid"],
                ["album", "mid", null, "albummid"],
                ["album", "name", null, "albumname"],
                ["mv", "vid", null, "vid"],
                [null, "interval", null, "interval"],
                [null, "isonly", null, "isonly"],
                [null, "url", null, "songUrl"]
            ],
            format: function (e, t) {
                var n = void 0;
                if (a.isObject(e)) {
    ...
    var s = function () {
            function e(t) {
                ...
                if (n.target = r.opts.target, a.ua.music) {
                    var c = 0,
                        d = function () {
                            var e = ++c;
                            a.client.open("media", "getCurrentSong", {
                                list: 1
                            }, function (t) {
            ...
            return _createClass(e, null, [{
                ...
                value: function (t, n, i) {
                    ...
                    var r = [],
                        ...
                        c = [],
                        d = n.needUrl,
                        g = "//u.y.qq.com/cgi-bin/musicu.fcg",
                        p = function (e) {
                    ...
                    a.series([function (e, i) {
                        (t = a.serializeSongData(t)).forEach(function (e, t) {
                            if (a.isNormSong(e)) {
                                var i = a.cache.get(e);
                                n.force || !i ? e.mid ? (s.push(e.mid), u.push(e.type)) : (r.push(e.id), o.push(e.type)) : d && i && !i.url && a.canPlay(i) && (l.push(i.mid), c.push(i.type))
                            }
                        }), d && (l = l.concat(s), c = c.concat(u)), s.length || r.length || l.length ? i() : p()
                    }, function (e, t) {
                        var n = {};
                        s.length && (n.data_mid = f({
                            mids: s,
                            types: u
                        })), r.length && (n.data_id = f({
                            ids: r,
                            types: o
                        })), l.length && (n.url_mid = h({
                            mids: l,
                            types: c
                        })), a.jsonp({
                            url: g,
                        ...
                        o ? n(o) : (t.url_mid && m(t.url_mid, c), n(null, i))
                    }, function (e, t) {
                ...
                value: function (e) {
                    ...
                    return o || (o = a.createAudio({
                        ...
                        timeupdate: function () {
                            n._trigger("timeupdate", {
                                currentTime: o.currentTime
                            })
                        },
                        error: function () {
                            o.src && n._trigger("error", {
                                code: PLAY_SONG_FAIL
                            })
                        },
                ...
                value: function (t, n) {
                    ...
                    var g, p = n.target ? a.getTarget(n.target) : i.target,
                        f = p !== l.MUSIC;
                    return g = function (e) {
                        var t = e.length;
                        if (0 != t) {
                            ...
                            if (null != n.index && t > 0 && (c = e[l = (l = parseInt(n.index)) % t + (l < 0 ? t : 0)]), s.index = l, s.songs = e, s.params = n, f) {
                                ...
                                if (o.filter) {
                                    ...
                                    if (e.forEach(function (e) {
                                            r(e) && m.push(e)
                                        }), !m.length) return i.__triggerSongInvalid();
                                    s.songs = e = m, c && (l = e.indexOf(c), s.index = l = l > 0 ? l : 0)
                                }
                            }
                    ...
                    }, t ? (f && i._webPlay(), e.getSongInfo(t, {
                        needUrl: f
                    }, function (e, t) {
                        e ? i._trigger("error", {
                            code: c.GET_SONG_INFO_FAIL
                        }) : g(t)
                ...
                value: function () {
                    var e = this.__,
                        ...
                        n = e.data,
                        i = this.data.index - 1;
                    return (t.loop || n.songs[i]) && this.play(null, {
                        index: i
                    }), this
                }
            }, {
